...
// SCREAMMING_SERVERDlg.cpp: 구현 파일
//
...
CSCREAMMINGSERVERDlg::CSCREAMMINGSERVERDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_SCREAMMING_SERVER_DIALOG, pParent)
{
...
void CSCREAMMINGSERVERDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CSCREAMMINGSERVERDlg::OnPaint()
{
	if (IsIconic())
	{
...
//  이 함수를 호출합니다.
HCURSOR CSCREAMMINGSERVERDlg::OnQueryDragIcon()
{
